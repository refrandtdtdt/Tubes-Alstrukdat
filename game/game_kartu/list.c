...
void Set(List *L, IdxType i, Kartu v)
{
    L->A[i] = v;
}
...
void InsertFirst(List *L, Kartu X)
{
    if(!IsListEmpty(*L))
    {
...
void InsertLast(List *L, Kartu X)
{
    if (IsListEmpty(*L)) {
        InsertFirst(L, X);
    } else {
