...
void node4(int *score, char* player, Address *p)    {
    ...
    printf("Bu Kumakawa: \"Jadi begini, 1 minggu lagi Megumi-chan akan menjalankan perawatan untuk penyakitnya, namun bisa saja ini akan menyebabkan Megumi meninggal dunia.\"");START();system("cls");
    ...
    printf("%s: \"Oke bu, saya terima. Terima kasih banyak, Bu Kumakawa.\"", player);START();system("cls");
    printf("Akhirnya aku pergi ke rumah Keluarga Kumakawa bersama Ibunya Megumi.");START();system("cls");
    printf("Sesampainya di rumah tersebut. Megumi dan Pak Kumakawa sudah menyambutku.");START();system("cls");
    printf("Pak Kumakawa: \"Oi, %s rupanya, ayo silakan makan!\"", player);START();system("cls");
    ...
    printf("Bu Kumakawa: \"Hihihihi. ya sudah, silakan ambil makanan.\"");START();system("cls");
...
void node5(int *score, char* player, Address *p)    {
    ...
    printf("Kumakawa: Coba kamu ke Rumah Sakit Tanigawa, Megumi juga ingin ngomong sama kamu");START();system("cls");
    ...
    printf("%s: \"Permisi, Ruangan pasien Atas Nama Kumakawa Megumi di mana ya?\"", player);START();system("cls");
    ...
    printf("Kumakawa: \"Ini surat dari Megumi. katanya ia akan berikan pada hari ini.\"");START();system("cls");
