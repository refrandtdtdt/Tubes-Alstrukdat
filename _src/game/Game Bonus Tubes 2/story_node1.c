...
void node1(int *score, char* player, Address *p)
{
    ...
    printf("kubuka halaman depan buku itu, kubaca kembali kenangan masa Sekolah Dasarku, tertulis pengalamanku bersama Miya.");START();system("cls");
    printf("aku dan Miya adalah teman dari masa kecil. dulu kami selalu bermain bersama.");START();system("cls");
    printf("perkenalan awalku dimulai ketika Bu Kumakawa datang ke tempatku. ia membawa Miya sambil memperkenalkan diri.");START();system("cls");
    printf("Bu Kumakawa: \"Tolong kenalin dirimu ya, Miya-chan.\"");START();system("cls");
    printf("Miya: \"Baik, Okaa-san\"");START();system("cls");
    printf("Miya: \"Halo, Namaku Miya, Kumakawa Miya. Salam Kenal\"");START();system("cls");
    printf("%s: \"oke, namaku %s, salam kenal ya!\"", player, player);START();system("cls");
    printf("Miya: \"Salam kenal, %s-San.\"", player);START();system("cls");
    ...
    printf("Miya: \"Nanti kita masuk ke sekolah yang sama ya!!!\"");START();system("cls");
    printf("kami berusaha menepatinya bersama.");START();system("cls");
    printf("namun sayang hingga saat tes masuk ke SMP diumumkan, ternyata nilaiku masih kurang untuk masuk ke SMP favorit yang jadi pilihan Miya, akhirnya kami berpisah saat itu karena aku pindah kota untuk mencari sekolah terbaik lain yang ada di luar kota. kami pun akhirnya jarang bertemu semenjak itu.");START();system("cls");
    ...
    printf("lalu kulihat wajah familiar yang sudah lama aku tidak melihat, ternyata ada Miya yang duduk sambil memandangi jendela kelas.");START();system("cls");
    printf("di belakang Miya terdapat kursi kosong. aku kemudian duduk di kursi tersebut.");START();system("cls");
    printf("begitu ku duduk di bangku, ia menyapaku");START();system("cls");
    printf("Miya: \"Kamu %s-kun kan?\"", player);START();system("cls");
    printf("Miya: \"Kita udah lama banget enggak ketemu.\"");START();system("cls");
    printf("Miya: \"Gimana Kabarmu?\"");START();printf("\n\n");
    validinput = false;
    ...
    if (input == 1) {
        *score += 300;
        printf("Score +300\n\n");
        printf("Miya: \"Oh, syukurlah. kamu udah cukup tinggi, ya.\"");START();//system("cls");
        printf("%s: \"Namanya juga tumbuh dewasa\"", player);START();system("cls");
    }
    else if (input == 2){
        *score -= 200;
        printf("Score -200\n\n");
        printf("Miya: \"Ih kamu, baru ketemu lagi udah songong aja.\"\n");START();//system("cls");
    ...
    printf("Pina: \"Halo Miya-chan, halo %s\"", player);START();system("cls");
    validinput = false;
    printf("1. \"Apa kabar!\"\n2. \"Halo, Pina\"\n\nSilakan pilih opsi dialog(1/2): ");
    while (!validinput)    {
        //scanf("%d", &input);
    ...
    printf("Enji: \"eh, masa cuma Anip doang yang disapa, lha terus aku gimana?\"");START();system("cls");
