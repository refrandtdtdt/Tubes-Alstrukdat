...
void node1(int *score, char* player, Address *p)
{
    ...
    printf("%s: \"oke, namaku %s, salam kenal ya!\"", player, player);scanf("%c", &dummy);system("cls");
    printf("Miya: \"Salam kenal, %s-San.\"", player);scanf("%c", &dummy);system("cls");
    printf("semenjak itu, kita semakin akrab. aku dan dia menikmati waktu bersama bermain di taman bermain dekat rumah, bermain petak umpet bersama teman-temanku yang lain, belajar matematika bareng di rumahku, kebetulan juga ayahku seorang guru matematika. dan kami juga bersekolah di sekolah yang sama.");scanf("%c", &dummy);system("cls");
    ...
    printf("namun sayang hingga saat tes masuk ke SMP diumumkan, ternyata nilaiku masih kurang untuk masuk ke SMP favorit yang jadi pilihan Miya, akhirnya kami berpisah saat itu karena aku pindah kota untuk mencari sekolah terbaik lain yang ada di luar kota. kami pun akhirnya jarang bertemu semenjak itu.");scanf("%c", &dummy);system("cls");
    ...
    printf("Miya: \"Kamu %s-kun kan?\"", player);scanf("%c", &dummy);system("cls");
    ...
    if (input == 1) {
        *score += 300;
        printf("Score +300\n\n");
        printf("Miya: \"Oh, syukurlah. kamu udah cukup tinggi, ya.\"\n");scanf("%c", &dummy);//system("cls");
        printf("%s: \"Namanya juga tumbuh dewasa\"", player);scanf("%c", &dummy);system("cls");
    }
    else if (input == 2){
        *score -= 200;
        printf("Score -200\n\n");
    ...
    //system("cls");
    printf("Pina: \"wah, ternyata lo inget gue juga\"\n");scanf("%c", &dummy);//system("cls");
    printf("%s:	\"ya jelas dong, kita kan friend. ya kan?\"", player);scanf("%c", &dummy);system("cls");
    ...
    if (input == 1) {
        *score += 100;
        printf("Score +100\n\n");
        printf("Refrendt: \"mari kita lihat nanti, hehe\"\n");scanf("%c", &dummy);//system("cls");
        *p = LEFT(*p);
    }
    else if (input == 2){
